...
Code structure:
    ...
    The test case in TieBreakerTest.java can be run as integration test case.

    The test cases are in test dir which mimics the source package structure. Building the project with
    gradle executes the test cases. The directory test/resources contain various input file which contains
...
What is not considered:
    ...
    4. The result of tie breaker can be Tie as well and is mentioned in corresponding scenarios.
